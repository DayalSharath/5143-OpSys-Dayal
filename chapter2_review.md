...
The kernel performs its tasks, such as executing processes and handling interrupts, in kernel space. When a process makes requests of the kernel, the request is called a system call.
